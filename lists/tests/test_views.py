...
class ListViewTest(TestCase):
    ...
    def test_can_save_post_request_to_existing_list(self):
        correct_list = List.objects.create()
        another_list = List.objects.create()
        self.client.post('/lists/%d/' % (correct_list.id,), {'text':'A new item for a existing list'})
    ...
    def test_post_redirects_to_list_view(self):
        ...
        response = self.client.post('/lists/%d/' % (correct_list.id,), {'text':'test'})
...
class NewListTest(TestCase):
    ...
    def test_validation_errors_are_show_in_the_home_page(self):
        response = self.client.post('/lists/new', data={'text':''})
        self.assertContains(response, escape(EMPTY_ITEM_ERROR))
